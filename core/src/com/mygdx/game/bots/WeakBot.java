...
public class WeakBot extends Bot {
    ...
    public WeakBot(Shattle shattle, float x, float y) {
        ship = new Texture("weakBot.png");
        ship2 = new Texture("weakBot2.png");
        ship3 = new Texture("weakBot3.png");
        hitPoints = 100;
        posX = x;
        posY = y;
        speed = (float) ((Math.random()*0.0151)+0.005);
        rotation = 180;
